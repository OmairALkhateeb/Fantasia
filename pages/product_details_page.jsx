...
const ProductDetailsPage = () => {
  ...
  const images = [
    ...
    { id: 1, image: '/assets/images/man2.jpeg' }, 
    { id: 1, image: '/assets/images/man3.jpeg' },  
    { id: 1, image: '/assets/images/man3.jpeg' },  
  ];
  ...
  const fitProductData = [
    { id: 4, image: '/assets/images/add3.avif', title: 'تيشرت', subtitle: 'IQD - 10,000', subtitle2: 'IQD - 25,000', percentage: '75%', quantity: '55', code: "13" },
    { id: 5, image: '/assets/images/add3.avif', title: 'تيشرت', subtitle: 'IQD - 10,000', subtitle2: 'IQD - 25,000', percentage: '75%', quantity: '55', code: "13" },
    { id: 6, image: '/assets/images/add3.avif', title: 'تيشرت', subtitle: 'IQD - 10,000', subtitle2: 'IQD - 25,000', percentage: '75%', quantity: '55', code: "13" },
    { id: 7, image: '/assets/images/add3.avif', title: 'تيشرت', subtitle: 'IQD - 10,000', subtitle2: 'IQD - 25,000', percentage: '75%', quantity: '55', code: "13" },
    { id: 8, image: '/assets/images/add3.avif', title: 'تيشرت', subtitle: 'IQD - 10,000', subtitle2: 'IQD - 25,000', percentage: '75%', quantity: '55', code: "13" },
    { id: 9, image: '/assets/images/add3.avif', title: 'تيشرت', subtitle: 'IQD - 10,000', subtitle2: 'IQD - 25,000', percentage: '75%', quantity: '55', code: "13" },
    { id: 10, image: '/assets/images/add3.avif', title: 'تيشرت', subtitle: 'IQD - 10,000', subtitle2: 'IQD - 25,000', percentage: '75%', quantity: '55', code: "13" },
    { id: 11, image: '/assets/images/add3.avif', title: 'تيشرت', subtitle: 'IQD - 10,000', subtitle2: 'IQD - 25,000', percentage: '75%', quantity: '55', code: "13" },
  ];
...
<section id="product-details-section" className="py-12 px-4 md:px-12 bg-[#000112]">
  <Nav />
  <div class="py-12 px-16 flex flex-col lg:flex-row custom-flex justify-center items-start min-h-screen bg-gray-800    mx-auto">
  ...
  <div className="px-12 w-full lg:w-2/5 flex justify-center lg:justify-end px-4 lg:px-8 mb-8 lg:mb-0">
    ...
    <div className="w-full lg:w-1/2 flex flex-col text-right px-4 overflow-y-auto">
      <p className="text-white text-lg mb-4 py-4">shirt</p>
      <p className="text-white text-4xl font-semibold mb-6">{product.name}</p>
