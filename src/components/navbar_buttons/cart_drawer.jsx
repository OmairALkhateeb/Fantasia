...
const CartDrawer = ({ isOpen, toggleDrawer }) => {
  ...
  // Sample cart data, replace with dynamic data if needed
  const [cartData, setCartData] = useState([
    { id: 1, name: "TI-shirt", price: 450000, discount: 50000, image: "/assets/images/add1.avif", quantity: 1 },
    { id: 2, name: "TI-shirt", price: 300000, discount: 30000, image: "/assets/images/add2.avif", quantity: 1 },
  ]);
      ...
      >
        ...
        <div className="mt-4 text-white text-right">
          <div className="flex justify-between py-4">
            ...
            <p className="font-semibold">: السعر قبل الخصم</p>
          </div>
